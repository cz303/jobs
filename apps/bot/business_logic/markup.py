...
class Markup:
    ...
    def get_data(cls):
        ...
        data['4. Реклама, маркетинг, PR'] = [
            '◀️ Назад',
            'Копирайтер',
            'Арт-директор | Креативный-директор',
            'Менеджер | Менеджер по рекламе',
            'Маркетолог-аналитик | Социолог',
            'Промоутер | Медиапланер',
            'Мерчандайзер | Распространитель',
        ]
        data['5. Бухгалтерия, финансы, учет | аудит'] = [
            '◀️ Назад',
            'Бухгалтер',
            'Кассир',
            'Экономист',
        ...
        data['6. Туризм и спорт'] = [
            '◀️ Назад',
            'Экскурсовод | Менеджер',
            'Тренер в спортзал',
            'Инструктор',
        ]
        data['7. Юриспруденция, право'] = [
            '◀️ Назад',
            'Юрист | Помощник юриста',
            'Адвокат | Помощник адвоката',
            'Нотариус | Помощник нотариуса',
        ]
        data['8. Гостиничный бизнес'] = [
            '◀️ Назад',
            'Горничная | Уборщица в хостел',
            'Швейцар | Управляющий отелем',
        ]
        data['9. Дизайн, творчество'] = [
            '◀️ Назад',
            'Фотограф | Иллюстратор',
            'Дизайнер | Интерьера | Текстилю',
            'Художник',
        ...
        data['13. Логистика, доставка, склад'] = [
            '◀️ Назад',
            'Курьер | Экспедитор',
            'Кладовщик | Заведующий складом',
            'Работник склада | Маркировщик',
            'Менеджер аналитик - логистик',
            'Специалист по перевозкам',
            'Водитель погрузчика'
        ]
        data['14. Медицина, фармацевтика'] = [
            '◀️ Назад',
            'Врач',
            'Медсестра | Фельдшер',
            'Сиделка',
        ...
        data['15. Недвижимость и страхование'] = [
            '◀️ Назад',
            'Агент по страхованию',
            'Риэлтор | Агент по недвижимости',
        ]
        data['16. Офисный персонал'] = [
            '◀️ Назад',
            'Администратор(офисный персонал)',
            'Оператор ПК | Аккаунт - менеджер',
            'Ассистент руководителя',
            'Секретарь | Офис - менеджер',
            'Диспетчер | Оператор Call - центра',
        ]
        data['17. Ресторанный бизнес, кулинария'] = [
            '◀️ Назад',
            'Обвальщик мяса',
            'Администратор(ресторанный бизнес)',
            'Официант | Бармен',
            'Шеф - повар | Повар | Мангальщик',
            'Кондитер | Пекарь',
            'Пиццайоло',
            'Сушист | Су - шеф',
        ]
        data['18. Сельское хозяйство, агробизнеc'] = [
            '◀️ Назад',
        ...
        data['19. Сфера развлечений'] = [
            '◀️ Назад',
            'Дилер',
            'Администратор(сфера развлечений)',
            'Танцовщица',
            'Шоумен',
            'Крупье',
        ...
        data['20. Торговля, продажи, закупки'] = [
            '◀️ Назад',
            'Кассир',
        ...
        data['21. Транспорт, автосервис'] = [
            '◀️ Назад',
            'Водитель | Водитель - экспедитор',
            'Автослесарь | Рихтовщик',
            'Автоэлектрик | Инжекторник',
            'Моторист',
            'Мойщик | Шиномонтажник',
            'Оператор АЗС',
        ]
        return data
