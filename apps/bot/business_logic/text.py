...
class Text:
    ...
    def publish(self, user):
        if user.profile == 2:
            ...
            self.text = '<b>Одобрено!</b>\n' \
                        'Я сделаю бесплатную рассылку твоей ' \
                   'вакансии 10 потенциальным кандидатам, которых она может ' \
                   'заинтересовать. А также добавлю её в поиск. ' \
                   'Чтобы начать рассылку, жми кнопку - "Начать".' \
                   '<a href="https://' \
