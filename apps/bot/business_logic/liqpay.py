...
class LiqPay(object):
    FORM_TEMPLATE = """\
        ...
        \t{param_inputs}
            <input type="image" src="//static.liqpay.ua/buttons/p1{language}.
    ...
    def _make_signature(self, *args):
        ...
        return base64.b64encode(hashlib.sha1(
            joined_fields).digest()).decode("ascii")
    ...
    def api(self, url, params=None):
        ...
        signature = self._make_signature(
            private_key, json_encoded_params, private_key)
    ...
    def cnb_form(self, params):
        ...
        format_input = (lambda k, v: self.INPUT_TEMPLATE.format(name=k,
                                                                value=v))
    ...
    def cnb_signature(self, params):
        ...
        return self._make_signature(
            self._private_key, data_to_sign, self._private_key)
    ...
    def str_to_sign(self, str):
        return base64.b64encode(hashlib.sha1(
            str.encode("utf-8")).digest()).decode("ascii")

    def data_to_sign(self, params):
        return base64.b64encode(json.dumps(
            params).encode("utf-8")).decode("ascii")
    ...
    def decode_data_from_str(self, data):
        ...
        Args:
            data: json string with api params and encoded by
        ...
        Example:
            ...
            print(response)
            {'commission_credit': 0.0, 'order_id': 'order_id_1',
